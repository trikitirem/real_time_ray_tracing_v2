...
inline void append_quad(std::vector<util::Vertex>& vertices, std::vector<util::Index>& indices,
                        glm::vec3 v0, glm::vec3 v1, glm::vec3 v2, glm::vec3 v3, glm::vec3 normal) {
...
[[nodiscard]] inline Model make_cube(float width, float height, float depth,
    ...
    // +Z
    detail::append_quad(prim.vertices, prim.indices, glm::vec3(-hx, -hy, hz),
                        glm::vec3(hx, -hy, hz), glm::vec3(hx, hy, hz), glm::vec3(-hx, hy, hz),
    ...
    detail::append_quad(prim.vertices, prim.indices, glm::vec3(hx, -hy, -hz),
                        ...
                        glm::vec3(0.0f, 0.0f, -1.0f));
    // +X
    detail::append_quad(prim.vertices, prim.indices, glm::vec3(hx, hy, hz), glm::vec3(hx, -hy, hz),
