...
inline constexpr std::array<vk::DescriptorSetLayoutBinding, 2> kCameraDescriptorBindings = {
...
inline constexpr std::array<vk::DescriptorPoolSize, 2> kCameraDescriptorPoolSizes = {
