...
class RasterFrameRecorder final : public FrameRecorder {
  public:
    ...
    void set_scene_data(const RasterSceneGpuData* scene_data) {
    ...
    void
    set_default_texture_uniform_set(const descriptors::UniformSet* default_texture_uniform_set) {
        default_texture_uniform_set_ = default_texture_uniform_set;
    }
    void set_per_texture_uniform_sets(
        const std::vector<descriptors::UniformSet>* per_texture_uniform_sets) {
