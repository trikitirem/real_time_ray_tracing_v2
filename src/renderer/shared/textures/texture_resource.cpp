...
std::uint32_t TextureResource::find_memory_type(const vk::PhysicalDeviceMemoryProperties& mem_props,
...
TextureResource TextureResource::create_solid_rgba(const vk::raii::PhysicalDevice& physical_device,
