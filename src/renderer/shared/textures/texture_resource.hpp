...
class TextureResource {
  public:
    ...
    static TextureResource load_from_asset_location(const vk::raii::PhysicalDevice& physical_device,
                                                    const vk::raii::Device& device,
                                                    const vk::raii::CommandPool& command_pool,
                                                    const vk::raii::Queue& graphics_queue,
                                                    const util::AssetLocation& location);

    static TextureResource create_solid_rgba(const vk::raii::PhysicalDevice& physical_device,
                                             const vk::raii::Device& device,
                                             const vk::raii::CommandPool& command_pool,
                                             const vk::raii::Queue& graphics_queue, std::uint8_t r,
                                             std::uint8_t g, std::uint8_t b, std::uint8_t a = 255);

    [[nodiscard]] const vk::raii::Image& image() const {
        return image_;
    }
    [[nodiscard]] const vk::raii::ImageView& view() const {
        return view_;
    }
    [[nodiscard]] const vk::raii::Sampler& sampler() const {
        return sampler_;
    }
  ...
  private:
    ...
    static void transition_image_layout_one_shot(const vk::raii::Device& device,
                                                 const vk::raii::CommandPool& command_pool,
                                                 const vk::raii::Queue& queue, vk::Image image,
                                                 vk::ImageLayout old_layout,
                                                 vk::ImageLayout new_layout);

    static void copy_buffer_to_image_one_shot(const vk::raii::Device& device,
                                              const vk::raii::CommandPool& command_pool,
                                              const vk::raii::Queue& queue, vk::Buffer src_buffer,
                                              vk::Image dst_image, vk::Extent2D extent);
