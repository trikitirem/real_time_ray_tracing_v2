...
vk::Extent2D chooseSwapExtent(const vk::SurfaceCapabilitiesKHR& caps, std::uint32_t fbWidth,
...
void Swapchain::createSwapchainResources(DeviceContext& ctx, int framebufferWidth,
    ...
    vk::SurfaceCapabilitiesKHR caps = physical.getSurfaceCapabilitiesKHR(*surface);
    ...
    extent_ = chooseSwapExtent(caps, static_cast<std::uint32_t>(std::max(0, framebufferWidth)),
    ...
    vk::SwapchainCreateInfoKHR ci{
        ...
        .pQueueFamilyIndices =
            (sharingMode == vk::SharingMode::eConcurrent) ? familyIndices.data() : nullptr,
