...
class BaseBuffer {
  public:
    ...
    [[nodiscard]] const vk::raii::Buffer& buffer() const {
        return buffer_;
    }
    [[nodiscard]] vk::DeviceSize size_bytes() const {
        return size_bytes_;
    }
  ...
  protected:
    ...
    BaseBuffer(const vk::raii::PhysicalDevice& physical_device, const vk::raii::Device& device,
               BufferKind kind);

    void create_with_memory(vk::DeviceSize size_bytes, vk::BufferUsageFlags usage,
                            vk::MemoryPropertyFlags memory_properties, bool require_device_address);

    [[nodiscard]] static Allocation
    create_allocation(const vk::raii::Device& device,
                      const vk::PhysicalDeviceMemoryProperties& mem_props,
                      vk::DeviceSize size_bytes, vk::BufferUsageFlags usage,
                      vk::MemoryPropertyFlags memory_properties, bool require_device_address);

    [[nodiscard]] static std::uint32_t
    find_memory_type(const vk::PhysicalDeviceMemoryProperties& mem_props, std::uint32_t type_bits,
    ...
    static void copy_buffer_one_shot(const vk::raii::Device& device,
                                     ...
                                     const vk::raii::Queue& queue, vk::Buffer src, vk::Buffer dst,
